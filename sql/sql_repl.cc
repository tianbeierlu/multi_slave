...
int start_slave(THD* thd , Master_info* mi,  bool net_report)
{
	...
	other thread
	*/
	mi->rli.opt_slave_apply_threads_inner = opt_slave_apply_threads;
	multi_slave_get_distribute_mode(&mi->rli, opt_slave_apply_distribute_mode);

	if (thd->lex->slave_thd_opt)
		thread_mask&= thd->lex->slave_thd_opt;

	if (mi->rli.sql_thread_running)
		thread_mask = 0;
...
@retval 1 error
*/
int stop_slave(THD* thd, Master_info* mi, bool net_report, bool free_msti )
{
