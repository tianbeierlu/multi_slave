...
static const char *my_locale_month_names_be_BY[13] = 
 {"Студзень","Люты","Сакав?к","Красав?к","Травень","Чэрвень","Л?пень","Жн?вень","Верасень","Кастрычн?к","Л?стапад","Снежань", NullS };
static const char *my_locale_ab_month_names_be_BY[13] = 
 {"Стд","Лют","Сак","Крс","Тра","Чэр","Л?п","Жнв","Врс","Кст","Л?с","Снж", NullS };
static const char *my_locale_day_names_be_BY[8] = 
 {"Панядзелак","А?торак","Серада","Чацвер","Пятн?ца","Субота","Нядзеля", NullS };
static const char *my_locale_ab_day_names_be_BY[8] = 
 {"Пан","А?т","Срд","Чцв","Пят","Суб","Няд", NullS };
...
static const char *my_locale_month_names_cs_CZ[13] = 
 {"leden","únor","b?ezen","duben","květen","?erven","?ervenec","srpen","zá?í","?íjen","listopad","prosinec", NullS };
static const char *my_locale_ab_month_names_cs_CZ[13] = 
 {"led","úno","b?e","dub","kvě","?en","?ec","srp","zá?","?íj","lis","pro", NullS };
static const char *my_locale_day_names_cs_CZ[8] = 
 {"Pondělí","útery","St?eda","?tvrtek","Pátek","Sobota","Neděle", NullS };
static const char *my_locale_ab_day_names_cs_CZ[8] = 
 {"Po","út","St","?t","Pá","So","Ne", NullS };
...
static const char *my_locale_day_names_et_EE[8] = 
 {"esmasp?ev","teisip?ev","kolmap?ev","neljap?ev","reede","laup?ev","pühap?ev", NullS };
...
static const char *my_locale_day_names_fo_FO[8] = 
 {"mánadagur","tysdagur","mikudagur","hósdagur","fríggjadagur","leygardagur","sunnudagur", NullS };
static const char *my_locale_ab_day_names_fo_FO[8] = 
 {"mán","tys","mik","hós","frí","ley","sun", NullS };
...
static const char *my_locale_month_names_fr_FR[13] = 
 {"janvier","février","mars","avril","mai","juin","juillet","ao?t","septembre","octobre","novembre","décembre", NullS };
static const char *my_locale_ab_month_names_fr_FR[13] = 
 {"jan","fév","mar","avr","mai","jun","jui","ao?","sep","oct","nov","déc", NullS };
...
static const char *my_locale_day_names_hu_HU[8] = 
 {"hétf?","kedd","szerda","csüt?rt?k","péntek","szombat","vasárnap", NullS };
...
static const char *my_locale_day_names_is_IS[8] = 
 {"mánudagur","triejudagur","mievikudagur","fimmtudagur","f?studagur","laugardagur","sunnudagur", NullS };
static const char *my_locale_ab_day_names_is_IS[8] = 
 {"mán","tri","mie","fim","f?s","lau","sun", NullS };
...
static const char *my_locale_month_names_lt_LT[13] = 
 {"sausio","vasario","kovo","baland?io","gegu??s","bir?elio","liepos","rugpjū?io","rugs?jo","spalio","lapkri?io","gruod?io", NullS };
...
static const char *my_locale_day_names_lv_LV[8] = 
 {"pirmdiena","otrdiena","tre?diena","ceturtdiena","piektdiena","sestdiena","svētdiena", NullS };
...
static const char *my_locale_month_names_mk_MK[13] = 
 {"?ануари","февруари","март","април","ма?","?уни","?ули","август","септември","октомври","ноември","декември", NullS };
static const char *my_locale_ab_month_names_mk_MK[13] = 
 {"?ан","фев","мар","апр","ма?","?ун","?ул","авг","сеп","окт","ное","дек", NullS };
...
static const char *my_locale_month_names_mn_MN[13] = 
 {"Нэгд?гээр сар","Хоёрдугаар сар","Гуравдугаар сар","Д?р?вд?гээр сар","Тавдугаар сар","Зургаадугар сар","Долоодугаар сар","Наймдугаар сар","Есд?гээр сар","Аравдугаар сар","Арваннэгд?гээр сар","Арванхоёрдгаар сар", NullS };
...
static const char *my_locale_day_names_mn_MN[8] = 
 {"Даваа","Мягмар","Лхагва","П?рэв","Баасан","Бямба","Ням", NullS };
static const char *my_locale_ab_day_names_mn_MN[8] = 
 {"Да","Мя","Лх","П?","Ба","Бя","Ня", NullS };
...
static const char *my_locale_month_names_pl_PL[13] = 
 {"styczeń","luty","marzec","kwiecień","maj","czerwiec","lipiec","sierpień","wrzesień","pa?dziernik","listopad","grudzień", NullS };
...
static const char *my_locale_day_names_pt_BR[8] = 
 {"segunda","ter?a","quarta","quinta","sexta","sábado","domingo", NullS };
...
static const char *my_locale_month_names_tr_TR[13] = 
 {"Ocak","?ubat","Mart","Nisan","May?s","Haziran","Temmuz","A?ustos","Eylül","Ekim","Kas?m","Aral?k", NullS };
...
static const char *my_locale_month_names_uk_UA[13] = 
 {"С?чень","Лютий","Березень","Кв?тень","Травень","Червень","Липень","Серпень","Вересень","Жовтень","Листопад","Грудень", NullS };
static const char *my_locale_ab_month_names_uk_UA[13] = 
 {"С?ч","Лют","Бер","Кв?","Тра","Чер","Лип","Сер","Вер","Жов","Лис","Гру", NullS };
static const char *my_locale_day_names_uk_UA[8] = 
 {"Понед?лок","В?второк","Середа","Четвер","П'ятниця","Субота","Нед?ля", NullS };
...
static const char *my_locale_month_names_vi_VN[13] = 
 {"Tháng m??t","Tháng hai","Tháng ba","Tháng t?","Tháng n?m","Tháng sáu","Tháng ba?y","Tháng tám","Tháng chín","Tháng m???i","Tháng m???i m??t","Tháng m???i hai", NullS };
...
static const char *my_locale_day_names_vi_VN[8] = 
 {"Th?? hai ","Th?? ba ","Th?? t? ","Th?? n?m ","Th?? sáu ","Th?? ba?y ","Chu? nha?t ", NullS };
...
{
  "Ιανου?ριο?", "Φεβρου?ριο?", "Μ?ρτιο?",
  "Απρ?λιο?",   "Μ?ιο?",       "Ιο?νιο?",
  "Ιο?λιο?",    "Α?γουστο?",   "Σεπτ?μβριο?",
  "Οκτ?βριο?",  "Νο?μβριο?",   "Δεκ?μβριο?", NullS
};
...
{
  "Δευτ?ρα",   "Τρ?τη",   "Τετ?ρτη", "Π?μπτη",
  "Παρασκευ?", "Σ?ββατο", "Κυριακ?", NullS
};
